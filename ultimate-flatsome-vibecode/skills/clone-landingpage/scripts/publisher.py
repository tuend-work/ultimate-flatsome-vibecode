...
# -*- coding: utf-8 -*-
"""
Ultimate Flatsome VibeCode - Page Publisher Tool
Đẩy nội dung VBC Elements đã được AI biên dịch lên WordPress qua REST API (/vbc/v1/page)
"""
...
def publish_page(title, slug, content_file_or_text, post_id=None, template="page-blank.php", status="publish"):
    ...
    with urllib.request.urlopen(req, timeout=30) as resp:
        ...
        print(f"UX Builder URL : {pub_url.rstrip('/')}/wp-admin/post.php?post={pub_id}&action=edit&app=uxbuilder" if 'wpcloud.vn' in pub_url else '')
        print("============================================================\n")
